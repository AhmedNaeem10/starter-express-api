...
const { getTasteProfile, getTasteProfiles, addTasteProfile, updateTasteProfile, deleteTasteProfile, getTasteProfilesByProduct, deleteTasteProfiles } = require("../controllers/TasteProfile");
...
module.exports = function(app) {
    ...
    app.post(TASTE_PROFILES.DELETE_TASTE_PROFILES, deleteTasteProfiles);
    app.put(TASTE_PROFILES.UPDATE_TASTE_PROFILE, upload.single('file'), updateTasteProfile);
